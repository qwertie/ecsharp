...
namespace Loyc.Collections
{
	...
	/// <li><see cref="IsSet(index)"/> returns the result of <see cref="SortedDictionary{K,V}.ContainsKey"/>, and</li>
	/// <li><see cref="IListSource{T}.TryGet(index, out bool)"/> returns the value 
	...
	/// <see cref="ClearSpace(index, index)"/> and <see cref="InsertSpace(index, index)"/>.
	...
	public interface ISparseList64<T> : ISparseListSource64<T>, IReadOnlyList64<T>
	{
		...
		void ClearSpace(index index, index count = 1);
