// Generated from ContractsMacro.ecs by LeMP custom tool. LeMP version: 1.7.6.0
	...
	partial class StandardMacros
	{
		...
		private class CodeContractRewriter
		{
			...
			LNode ConditionToStringLit(LNode condition, string formatStr)
			{
				...
				return F.Literal(string.Format(formatStr, ps.Print(methodName, Context.Sink, ParsingMode.Expressions), ps.Print(condition, Context.Sink, ParsingMode.Expressions)));
			}
