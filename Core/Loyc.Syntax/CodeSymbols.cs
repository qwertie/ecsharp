...
namespace Loyc.Syntax
{
	...
	public partial class CodeSymbols
	{
		...
		public static readonly Symbol Cast = GSymbol.Get("'cast");         //!< "'cast": @'cast(x,#int32) <=> (int)x <=> x(-> int)
		...
		[Obsolete("Renamed to SwitchStmt (use SwitchOp for the operator)")]
		...
		public static readonly Symbol SwitchOp = GSymbol.Get("'switch");     //!< e.g. @'switch(x, { ... }); <=> x switch { ... }
