...
namespace Loyc.Geometry
{
	...
	using Point3 = Point3<FPI8>;
	using Vector3 = Vector3<FPI8>;
	using System;
	...
	public static partial class VectorExt
	{
		...
		public static T Quadrance(this Vector3 v) { return v.X*v.X + v.Y*v.Y + v.Z*v.Z; }
		/// <summary>Gets the length of the vector.</summary>
		public static T Length(this Vector v) { return Quadrance(v).Sqrt(); }
		public static T Length(this Vector3 v) { return Quadrance(v).Sqrt(); }
		...
		public static Vector MulDiv(this Vector v, T mul, T div)
		{
			return new Vector(v.X.MulDiv(mul, div), v.Y.MulDiv(mul, div));
		}
		public static Vector3 MulDiv(this Vector3 v, T mul, T div)
		{
			return new Vector3(v.X.MulDiv(mul, div), v.Y.MulDiv(mul, div), v.Z.MulDiv(mul, div));
		}
	}
}
