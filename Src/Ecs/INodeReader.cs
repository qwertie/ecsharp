...
namespace Loyc.CompilerCore
{
	...
	public interface INodeReader
	{
		...
		bool EqualsStructurally(INodeReader other, bool compareStyles = false);
	}
	...
	public static class NodeReader
	{
		...
		public static NestedEnumerable<DescendantsFrame, INodeReader> Descendants(this INodeReader self, NodeScanMode mode = NodeScanMode.YieldAllChildren)
		{
			return new NestedEnumerable<DescendantsFrame, INodeReader>(new DescendantsFrame(self, mode));
		}
		public static NestedEnumerable<DescendantsFrame, INodeReader> DescendantsAndSelf(this INodeReader self)
		{
			return new NestedEnumerable<DescendantsFrame, INodeReader>(new DescendantsFrame(self, NodeScanMode.YieldAll));
		}
	...
	public struct DescendantsFrame : IEnumeratorFrame<DescendantsFrame, INodeReader>, ICloneable<DescendantsFrame>
	{
		INodeReader _node;
		IListSource<INodeReader> _children;
		NodeScanMode _mode;
		int _step, _index;
		
		public DescendantsFrame(INodeReader node, NodeScanMode mode)
		{
			_node = node;
			_mode = mode;
			_children = null;
		...
		public int MoveNext(ref DescendantsFrame frame, ref INodeReader current)
		{
			...
			case 3: // consider whether to return head
				if (_node.Head == null || (_mode & (NodeScanMode.ScanHeads | NodeScanMode.YieldLocalHead)) == 0)
					goto case 5; // skip attrs
				goto case 4;
			case 4: // return head
				subMode = SubMode(NodeScanMode.YieldLocalHead);
				frame = new DescendantsFrame(_node.Head, subMode);
				_step = 5;
				return -1;
