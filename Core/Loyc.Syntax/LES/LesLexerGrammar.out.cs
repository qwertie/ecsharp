...
namespace Loyc.Syntax.Les
{
	...
	public partial class LesLexer
	{
		...
		void FancyId()
		{
			...
			// Line 118: (() | (LettersOrPunc | IdExtLetter) (LettersOrPunc | IdExtLetter)*)
			la0 = LA0;
		...
		public override Maybe<Token> NextToken()
		{
			...
			// Line 165: ( &{InputPosition == 0} Shebang / Symbol / Id / Newline / SLComment / MLComment / Number / TQString / DQString / SQString / BQOperator / Comma / Semicolon / LParen / [)] / [[] / [\]] / [{] / [}] / At / Operator )
			do {
				la0 = LA0;
				switch (la0) {
				case '#':
