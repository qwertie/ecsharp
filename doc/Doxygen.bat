...
sed --in-place -r "s_<li>.*(/Src/.*)</li>_<li><a href='https://github.com/qwertie/Loyc/blob/master\1'>\1</a></li>_;s_The documentation for this [a-z]* was generated from the following_Source_" ./code/*.html
