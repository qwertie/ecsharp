...
namespace Loyc.CompilerCore
{
	...
	public interface ILexingProvider
	{
		...
		/// </remarks>
		IParseNext<IToken> NewCoreLexer(ICharSource source);
		...
		/// </summary>
		IEnumerable<IToken> NewLexer(ICharSource source);
		...
		/// </remarks>
		IEnumerable<IToken> NewPreprocessor(IEnumerable<IToken> lexer);
		...
		/// </remarks>
		IEnumerable<IToken> NewTreeParser(IEnumerable<IToken> preprocessedInput);
	}
	...
	public interface IParsingProvider
	{
		...
		IStmtParserBuilder<IAstNode, IToken> NewFileParser();
		IStmtParserBuilder<IAstNode, IToken> NewMethodBodyParser();
		IStmtParserBuilder<IAstNode, IToken> NewClassBodyParser();
		/// <summary>
		...
		IExprParser<IAstNode, IToken> NewExprParser();
	}
}
